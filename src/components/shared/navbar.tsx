          ...
          <div className="flex gap-2 items-center">
            ...
            {isLoading ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  <p className="text-sm text-red-400 text-center">{user.isActivated ? "User activated" : "User is not activated"}</p>
              ...
              <Link to={"/auth"}>
                <Button size={"lg"} onClick={() => setAuth("login")} className="rounded-full font-bold">
                  Login
                </Button>
              </Link>
            )}
